...
@dag(
    ...
    schedule=None,
    start_date=pendulum.from_format("2024-09-10", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "Cristian Yeraldo Urcuqui Ortega": "mailto:cristianurcuqui@gmail.com",
        "Open in Cloud IDE": "https://cloud.astronomer.io/cm0vt052100vf01nel4wlj39y/cloud-ide/cm0vtdir200x601nebqxwfkp4/cm0vtdj1v00y601o4vgxn5dq1",
    },
)
